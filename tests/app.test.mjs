...
const { transcriptToVtt } = await import('../server.mjs');
...
const vtt = transcriptToVtt({
  text: '日本語の勉強を始めましょう。',
  words: [
    { text: '日本語', start: 0, end: 800 },
    { text: 'の', start: 800, end: 900 },
    { text: '勉強', start: 900, end: 1600 },
    { text: 'を', start: 1600, end: 1700 },
    { text: '始めましょう。', start: 1700, end: 2900 },
  ],
});
assert.ok(vtt.startsWith('WEBVTT'));
assert.ok(vtt.includes('00:00:00.000 --> 00:00:02.900'));
assert.ok(vtt.includes('日本語の勉強を始めましょう。'));
